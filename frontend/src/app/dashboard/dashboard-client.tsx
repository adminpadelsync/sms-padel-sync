...
export function DashboardClient({
    ...
    const [activeTab, setActiveTab] = useState<'players' | 'matches' | 'analytics'>('players')
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                {/* Summary Cards - Always Visible? No, maybe only on Overview or Players? Let's keep them always visible for now or maybe just for Players/Matches */}
                {/* Actually user requested separate views. Let's make Tabs main nav */}
                ...
                {/* Summary Cards (Only show on Players/Matches tabs for context) */}
                {activeTab !== 'analytics' && (
